...
try{
    ...
    $lead = $apiConnector->create(array(
	 ...
	 if( $lead ){
		header('Location: success.html?id='.$lead->id.'fb='.$_GET['fb']);
  }
...
{
    public $config = array(
        'api_key' => 'a617e5a723b8a1825c16cea660a31a94', //ключ веба
        'offer_id' => '',
        'user_id' => '50789', //id веба
    ...
    public function create($params)
    {
        $data = [
            ...
            'offer_id'  => empty($params['offer_id']) ? $this->config['offer_id'] : trim($params['offer_id']), //offer_id
